...
public class GuardScheduleReaderTest {
	...
	@Test
	public void multiplyMostConsistentGuardAndMinute_simpleInputOutsideChronologicalOrder() {
		// arrange
		List<String> input = Arrays.asList(
			"[1518-11-04 00:02] Guard #99 begins shift",
			"[1518-11-02 00:50] wakes up",
		...
		// act
		int result = GuardScheduleReader.multiplyMostConsistentGuardAndMinute(input);
